...
// Styles
import styles from './Styles/ProcessosViewStyle'

class ProcessosView extends React.PureComponent {
  /* ***********************************************************
  * STEP 1
  ...
  *************************************************************/
  ...
  renderSectionHeader ({section}) {
    switch (section.key) {
      case 'Finalizados':
        return <View style={styles.sectionHeader}><Text style={styles.boldLabel}>Finalizados</Text></View>
      default:
        return <View style={styles.sectionHeader}><Text style={styles.boldLabel}>Aguardando Assinatura</Text></View>
    }
  }
  ...
  *************************************************************/
  // Render a header?
  renderHeader = () =>
    <Text style={[styles.label, styles.sectionHeader]}> - Meus Processos - </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProcessosView)
